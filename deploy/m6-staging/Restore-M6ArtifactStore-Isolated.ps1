...
param(
    ...
    [string]$TargetVolumeName = 'administrative-m6-staging_administrative-m6-intake-artifacts-restore'
)

$ErrorActionPreference = 'Stop'
$resolvedArchive = (Resolve-Path -LiteralPath $ArchivePath -ErrorAction Stop).Path
if ($TargetVolumeName -eq 'administrative-m6-staging_administrative-m6-intake-artifacts') {
