...
[CmdletBinding()]
param(
    [string]$VolumeName = 'administrative-m6-staging_administrative-m6-intake-artifacts',
    [string]$OutputDirectory = 'D:\infrastructure\compose\administrative-orchestrator\deploy\m6-staging\backups'
)
...
$archiveName = "m6-artifacts-$stamp.tar.gz"
