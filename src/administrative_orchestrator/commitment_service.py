...
from .commitment_responsibility import (
    KernelCommitmentResponsibilityProvisioner as _KernelCommitmentResponsibilityProvisioner,
)
...
class KernelCommitmentResponsibilityProvisioner(_KernelCommitmentResponsibilityProvisioner):
    """Compatibility facade preserving the historical module-level Kernel bridge seam."""

    def __init__(self, store, *, settings: Settings) -> None:
        super().__init__(
            store,
            settings=settings,
            bridge_factory=lambda *args, **kwargs: KernelExecutionBridge(*args, **kwargs),
        )
...
class MeetingCommitmentService:
    ...
    def _dispatch_communication_via_kernel(
        ...
        *,
        ...
        return self._communication().dispatch_via_kernel(
