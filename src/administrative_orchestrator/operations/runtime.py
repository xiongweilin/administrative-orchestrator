...
def build_operations_runtime(settings: Settings | None = None) -> OperationsRuntime:
    ...
    kernel_reconciliation_verifier = LocalKernelReconciliationVerifier(
        repository=KernelBridgeRepository(store),
    ...
    investigation_service = InvestigationService(
        ...
        reconciliation_verifier=kernel_reconciliation_verifier,
    )
