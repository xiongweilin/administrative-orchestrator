...
class InvestigationService:
    def __init__(
        ...
        *,
        ...
        reconciliation_verifier: KernelReconciliationVerifier | None = None,
    ) -> None:
        self.store = store
        ...
        self.reconciliation_verifier = (
            reconciliation_verifier or UnavailableKernelReconciliationVerifier()
        )
    ...
    def request_investigation(
        ...
        *,
        ...
        if trigger.trigger_type is InvestigationTriggerType.OUTCOME_UNKNOWN:
            ...
            except KernelReconciliationVerificationError as exc:
